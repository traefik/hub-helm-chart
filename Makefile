...
# Needed by helm-unittest, even without using this snapshot feature
hub-agent/tests/__snapshot__:
	@mkdir hub-agent/tests/__snapshot__

test: hub-agent/tests/__snapshot__
